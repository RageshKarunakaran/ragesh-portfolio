                                            ...
                                            <Container>
                                              ...
                                              <Col
                                                    ...
                                                    <div className="portfolio_box mb-4">
                                                      <div class="cards">
                                                        <div class="card">
                                                          <div class="card__image">
                                                            <img
                                                              src="./Asia-s-Largest-NFT-Marketplace-Jump-trade.png"
                                                              alt=""
                                                            />
                                                          </div>
                                                          <h2 class="card__title">
                                                    ...
                                                    <div className="portfolio_box mb-4">
                                                      <div class="cards">
                                                        <div class="card">
                                                          <div class="card__image">
                                                            <img
                                                              src="./No-Code-NFT-Marketplace-Secure-Web3-Wallet-GuardianLink.png"
                                                              alt=""
                                                            />
                                                          </div>
                                                          <h2 class="card__title">
                                                    ...
                                                    <div className="portfolio_box mb-4">
                                                      <div class="cards">
                                                        <div class="card">
                                                          <div class="card__image">
                                                            <img
                                                              src="./GuardianWallet-Alpha-Release.png"
                                                              alt=""
                                                            />
                                                          </div>
                                                          <h2 class="card__title">
                                                ...
                                                <Col
                                                  ...
                                                  md={6}
                                                >
                                                  <a href="https://play.google.com/store/apps/details?id=com.guardianwalletnative&hl=en-IN&pli=1">
                                                    <div className="portfolio_box mb-4">
                                                      <div class="cards">
                                                        <div class="card">
                                                          <div class="card__image">
                                                            <img
                                                              src="./Guardian-Wallet-–-Apps-on-Google-Play.png"
                                                              alt=""
                                                            />
                                                          </div>
                                                          <h2 class="card__title">
                                                    ...
                                                    <div className="portfolio_box mb-4">
                                                      <div class="cards">
                                                        <div class="card">
                                                          <div class="card__image">
                                                            <img
                                                              src="./Fully-Faltoo-NFTs-NFT-drops-Premium-NFT-launchpad.png"
                                                              alt=""
                                                            />
                                                          </div>
                                                          <h2 class="card__title">
                                                    ...
                                                    <div className="portfolio_box mb-4">
                                                      <div class="cards">
                                                        <div class="card">
                                                          <div class="card__image">
                                                            <img
                                                              src="./Cube45-2021s-Best-Digital-Marketing-Company-in-Chennai.png"
                                                              alt=""
                                                            />
                                                          </div>
                                                          <h2 class="card__title">
